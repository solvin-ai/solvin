...
Fetches system and developer prompts from the agent registry via the shared client API.
...
from shared.client_agents import get_agent_role
...
def initialize_initial_turn_history(
    ...
    # 1) resolve context‐vars if not provided
    ...
    default_system = "Please respond with a valid json object. "
    ...
    developer_content = entry.get("default_developer_prompt", "")  # only this field
