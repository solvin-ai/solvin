...
async def admit_repo(
    ...
    """
    Insert into DB, run admission‐job pipeline (clone, detect, stats),
    ...
    # Path where jobs will clone/update the repo
    ...
    job_list   = get_admission_jobs()
    updated_info = run_admission_pipeline(repo_path, repo_info, job_list)
