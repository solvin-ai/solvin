...
def get_conversation_metadata(
    ...
    RPC-style:
      GET /turns/metadata?
        ...
        agent_id=…&
        repo_url=…
    Returns the free-form metadata dict for the given conversation.
    """
    # Ensure the TurnHistory is initialized so metadata exists
    get_turns_list(agent_role, agent_id, repo_url)
    md: Dict[str, Any] = get_turns_metadata(agent_role, agent_id, repo_url)
